#pragma checksum "C:\Users\bslwa\Desktop\V6 Desgin\V5\PersonnelJop\PersonnelJop\Pages\Setting\LateSetting.razor" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "120542ca518a45a650afedce6639843c32677ae8"
// <auto-generated/>
...
#line hidden
#nullable disable
    [Microsoft.AspNetCore.Components.RouteAttribute("/Delaysettings")]
    public partial class LateSetting : Microsoft.AspNetCore.Components.ComponentBase
    {
        #pragma warning disable 1998
        protected override void BuildRenderTree(Microsoft.AspNetCore.Components.Rendering.RenderTreeBuilder __builder)
        {
            __builder.AddMarkupContent(0, @"<div class=""container"" dir=""rtl"" style=""color: wheat;""><div class=""row row-cols-2""><div class=""col""><form class=""form-control"" align=""right""><h1>اعدادات التآخيرات</h1>
                <div><label>دقيقه</label>
                    <input type=""number"" placeholder=""الخصم بالدقيقه""></div>
                <div><label>ساعه</label>
                    <input type=""number"" placeholder=""الخصم بالساعه""></div></form></div>
        <div class=""col""><form class=""form-control""><h1>اعدادات الاوفر تايم</h1>
                <div><label>دقيقه</label>
                    <input type=""number"" placeholder=""الذياده بالدقيقه""></div>
                <div><label>ساعه</label>
                    <input type=""number"" placeholder=""الذياده بالساعه""></div></form></div>
        <button class=""btn btn-success"">حفظ</button></div></div>");
        }
